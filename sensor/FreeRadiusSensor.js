  ...
  async refreshDeviceTags(options = {}) {
    ...
    for (const [mac, staInfo] of Object.entries(staStatus)) {
      if (staInfo.dot1xUserName) {
        await this.setDeviceTag(mac, staInfo.dot1xUserName, staInfo.ssid, { dvlanId: staInfo.dvlanVlanId == null ? null : String(staInfo.dvlanVlanId), wpax: staInfo.wpax, auth: "dot1x" });
      }
    }
  }
